...
public final class ActivityLearnBinding implements ViewBinding {
  ...
  private ActivityLearnBinding(@NonNull RelativeLayout rootView,
      @NonNull BottomNavigationView bottomNavigation, @NonNull TextView definition,
      @NonNull ImageView imageView2, @NonNull ImageButton learnThisWord,
  ...
  public static ActivityLearnBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLearnBinding((RelativeLayout) rootView, bottomNavigation, definition,
          imageView2, learnThisWord, nextWord, phonetic, reviewWords, voice, word, wordtype);
    }
